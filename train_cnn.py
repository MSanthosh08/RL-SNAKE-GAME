...
def train_cnn():
    ...
    while True:
        ...
        if done:
            ...
            if score > record:
                record = score
                agent.model.save("cnn_model.pth")
            ...
            print(f"[CNN] Game {agent.n_games}  Score {score}  Record {record}  Mean {mean_score:.2f}")
